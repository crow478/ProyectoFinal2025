        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (SqlConnection cnx = new SqlConnection(connectionString))
                {
                    ...
                    string query = "INSERT INTO paciente (idUsuario, nombres, apellidos, edad, genero,departamento, municipio ) " +
                                   "VALUES (@idUsuario,@nombres, @apellidos, @edad,@genero,@departamento,@municipio)";
