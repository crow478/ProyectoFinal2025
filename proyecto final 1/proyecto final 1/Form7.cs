...
namespace proyecto_final_1
{
    public partial class Form7 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string query = @"INSERT INTO informacion_nutricional (idInformacionNutricional,descripcionNutricional,dietaNutricional,tiempoDieta)
                                                Values(@idInformacionNutricional,@descripcionNutricional,@dietaNutricional,@tiempoDieta)";
